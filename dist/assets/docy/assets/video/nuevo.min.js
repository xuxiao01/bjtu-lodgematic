...
!(function (e, t) {
  ...
  function i(e) {
    Object.prototype.hasOwnProperty.call(e, "data-simple-scrollbar") ||
      Object.defineProperty(e, "data-simple-scrollbar", { value: new r(e) });
  }
  function n(i) {
    for (
      this.target = i,
    ...
    "0px" === n.height &&
      "0px" !== n["max-height"] &&
      (i.style.height = n["max-height"]);
  }
  function a() {
    for (
      var e = t.querySelectorAll("*[ss-container]"), s = 0;
      s < e.length;
      s++
    )
      i(e[s]);
  ...
  (n.prototype = {
    moveBar: function (e) {
      ...
      (this.scrollRatio = i / t),
        s(function () {
          n.scrollRatio >= 1
            ? n.bar.classList.add("ss-hidden")
            : (n.bar.classList.remove("ss-hidden"),
              (n.bar.style.cssText =
                "height:" +
                Math.max(100 * n.scrollRatio, 10) +
                "%; top:" +
...
!(function (e, t) {
  ...
  function a(t, s) {
    var n = t.tech_,
      ...
      v = 0,
      c = 1;
    (r.isAddon = !1), (r.newstate = 4), (r.oldstate = 4), (r.events = {});
    var u,
      f = t.id(),
      h = ((o = t.el()), !1),
      p = ((n = t.$(".vjs-tech")), this),
      j = new Array(),
      m = (new Array(), new Array(), new Array(), !1);
    ...
    if (!0 === m) {
      ...
      ("undefined" != A && null !== A) || ((C = !1), (_ = "fullscreenToggle")),
        !document.pictureInPictureEnabled &&
          C &&
          (i.addClass(A, "vjs-hidden"), (_ = "fullscreenToggle"));
      ...
      var T = k.el_,
        w =
          '<span class="vjs-no-pointer"></span><div class="vjs-menu"><ul class="vjs-menu-content vjs-qlist" role="menu"></ul><div class="vjs-menu-header"><span class="vjs-header-title">' +
          t.localize("Quality") +
          '</span><div class="vjs-close-btn"></div></div></div>';
      if (((T.innerHTML = w), r.buttonForward)) {
        r.buttonRewind && se(!0);
        ...
        (x.el_.innerHTML =
          ...
          t.localize("Rewind") +
          "</span>"),
          "party" == e.options.skinname && r.buttonRewind
            ? t.controlBar.el_.insertBefore(
                x.el_,
                vjs_find(o, ".vjs-rewind-control").nextSibling
              )
            : t.controlBar.el_.insertBefore(
                x.el_,
                t.controlBar.getChild("playToggle").el_.nextSibling
              ),
      ...
      } else r.buttonRewind && se();
      var E = e.dom.createEl("div", { className: "vjs-vast-label" });
      (E.innerHTML = t.localize("Advertisement")),
        "party" == e.options.skinname
          ? t.controlBar.el_.insertBefore(
              E,
              t.controlBar.getChild("currentTimeDisplay").el_
            )
          : t.controlBar.el_.insertBefore(
              E,
              t.controlBar.getChild("playToggle").el_.nextSibling
      ...
      if (r.theaterButton) {
        ...
        t.controlBar.el_.insertBefore(
          M.el_,
          t.controlBar.getChild("fullscreenToggle").el_
        ),
          (M.el_.innerHTML = "<span></span>"),
          M.el_.addEventListener(
            setEvent("click"),
            function (e) {
              e.preventDefault(), e.stopPropagation();
              var s = M.el_;
              i.hasClass(s, "vjs-mode")
                ? (i.removeClass(s, "vjs-mode"), t.trigger("mode", "normal"))
                : (i.addClass(s, "vjs-mode"), t.trigger("mode", "large"));
            },
            !1
          );
      }
          ...
          function () {
            ie(),
              ...
              vjs_find(o, "vjs-menu-settings") &&
                i.addClass(vjs - menu - r, "vjs-hidden");
      ...
      if (
        ("" == r.title && (r.title = r.metatitle = document.title),
        "" == r.infoText && (r.infoText = r.metatitle),
        1 != r.errordisplay &&
          i.addClass(vjs_find(o, ".vjs-error-display"), "vjs-abs-hidden"),
        1 != r.timetooltip)
      ) {
          ...
          (O.onload = function () {
            if (
              ("naturalHeight" in this
                ? this.naturalHeight + this.naturalWidth === 0 && (W = !0)
                : this.width + this.height == 0 && (W = !0),
              1 != W)
            ) {
              ...
              t.controlBar
                .el()
                .insertBefore(e, t.controlBar.getChild("fullscreenToggle").el_);
            }
          });
      }
      if (r.contextMenu) {
            ...
            o.addEventListener("contextmenu", function (t) {
              ...
              if (
                ...
                var d = o.getBoundingClientRect(),
                  ...
                  c = l - d.left;
                v + n > o.offsetHeight &&
                  (v = o.offsetTop + o.offsetHeight - n),
      ...
      if (r.logo) {
        ...
        o.appendChild(Y),
          (F.onload = function () {
            ...
            if (
              ("RT" == r.logoposition
                ? ((Y.style.right = e + "px"), (Y.style.top = e + "px"))
                : ((Y.style.left = e + "px"), (Y.style.top = e + "px")),
              "" !== r.logourl)
            ) {
              var t = vjs_El("a");
              (t.href = r.logourl),
      ...
      if ("treso" == e.options.skinname) {
        ...
        Z.insertBefore(Q, Z.childNodes[0]), X.removeChild(K), Z.appendChild(K);
      }
      t.resetNuevo = function (s) {
        ...
        var v = t.tech({ IWillNotUseThisInPlugins: !0 }).el();
        if (!0 !== e.browser.IS_IOS)
          for (; v.firstChild; ) v.removeChild(v.firstChild);
        if ((1 == a.length && t.src(a), a.length > 1)) {
          var c = 0,
            f = 0;
          for (c = 0; c < a.length; c++) (a[c].res || a[c].label) && f++;
          if (f >= r.minResolution) {
            if (((r.dash = !1), (r.hls = !1), !t.src)) {
              var h = !1;
              return (
                ((r.relatedMenu && related.length > 0) ||
                  r.shareMenu ||
                  r.rateMenu ||
                  r.zoomMenu) &&
                  (h = !0),
                1 != h &&
                  vjs_find(o, ".vjs-cog-menu-button").vds.addClass(
                    "vjs-hidden"
                  ),
                t.src()
              );
            ...
            for (
              ...
              if (
                (void 0 !== N &&
                  ((-1 === N.indexOf("mpeg") && -1 === N.indexOf("apple")) ||
                    (r.hls = !0),
                ...
                -1 !== I.indexOf("mpeg") || -1 !== I.indexOf("apple")
                  ? ((m[C] = d[_]),
                    ++C > 1 && ((r.hls = !0), (r.hlsQualities = !1)))
                  : -1 !== I.indexOf("dash")
                  ? ((g[A] = d[_]),
                    ++A > 1 && ((r.dash = !0), (r.dashQualities = !1)))
                  : ((y[k] = d[_]), k++);
              }
            }
            var E = new Array();
            E = (E = m.length > 0 && x ? m : g.length > 0 && x ? g : y).sort(
              ce
            );
            var L = "",
              P = " vjs-checked";
                ...
                E[_].default
                  ? ((n = E[_]),
                    (b +=
                      ...
                      D +
                      "</li>"),
                    '<li class="quality-full vjs-checked" data-res="' +
                      _ +
                      '">' +
                      E[_].label +
                      D +
                  ...
                  : ((b +=
                      ...
                      D +
                      "</li>"),
                    '<li class="quality-full" data-res="' +
                      _ +
                      '">' +
                      E[_].label +
                      D +
            ...
            if (T > 1) {
              ...
              ((1 != r.hls && 1 != r.dash) || 1 != x) && ve(p.res, p.label),
                ...
                void 0 !== n || void 0 !== p
                  ? ((1 != r.hls && 1 != r.dash) ||
                      1 != x ||
                      (m.length > 1 && 1 != r.hlsQualities && x) ||
                      (g.length > 1 && 1 != r.dashQualities && x)) &&
                    (void 0 !== n && n != p
                      ? (ve(n.res, n.label), t.src(n), t.load())
                      : void 0 !== p &&
                        (ve(p.res, p.label), t.src(p), t.load()))
                  : ((m.length > 1 && x) || (g.length > 1 && x)) &&
                    ve("auto", "Auto");
            }
          }
        }
        ...
        if (
          (t.on("loadeddata", function () {
            for (
              var e = vjs_mfind(o, ".vjs-menu-button-popup"), s = 0;
              s < e.length;
              s++
            ) {
              function n(e) {
                o.offsetWidth < 480
                  ? i.addClass(o, "vjs-overflow")
                  : i.removeClass(o, "vjs-overflow");
            ...
            for (s = 0; s < a.length; s++) {
              ...
              function c(e) {
                if (
                  o.offsetWidth < 480 &&
                  "vjs-menu vjs-lock-showing" == e.target.className
                ) {
            ...
            if (x && 1 != q)
              try {
                ...
                I.length > 1 &&
                  r.dashQualities &&
                  (t.dash.mediaPlayer.setAutoSwitchQualityFor("video", !0),
                  I.forEach(function (e) {
                    var t = new Object();
                    "video" == e.mediaType &&
                      (e.height > 0 || e.bitrate > 0) &&
                      ((t.id = s),
                      e.height > 0 ? (t.height = e.height) : (t.height = 0),
                      e.bitrate > 0
                        ? (t.bitrate = parseInt(e.bitrate / 1e3))
                        : (t.bitrateh = 0),
                      s == E
                        ? ((t.auto = 1),
                          (T = !0),
                          e.height > 0 && (w = e.height),
                          e.bitrate > 0 && parseInt(e.bitrate / 1e3))
                        : (t.auto = 0),
                      k.push(t),
                      (u = "dash")),
                      (s += 1);
              ...
              try {
                t.tech_.hls.representations().forEach(function (e) {
                  ...
                  (e.height > 0 || e.bandwidth > 0) &&
                    ...
                    e.bandwidth &&
                      e.bandwidth > 0 &&
                      ((s.bitrate = parseInt(e.bandwidth / 1e3)),
                      i.attributes.BANDWIDTH == e.bandwidth &&
                        ((s.auto = 1), (T = !0), (w = e.height), e.bandwidth)),
                    (s.id = e.id),
                    (s.height = e.height),
                    k.push(s),
                    (u = "hls"));
            ...
            k.length > 0 &&
              ...
              (function (e, s, n, a) {
                if (j.length < 2) ne();
                  ...
                  r.is_auto = !0;
                  for (
                    var l = 0, d = 0, v = !1, c = 0, u = j.length;
                    c < u;
                    c++
                  )
                    if (
                  ...
                  var y = vjs_El(
                      "div",
                      "vjs-back-res vjs-hidden",
                      '<div class="vjs-res-header">' +
                        t.localize("Quality") +
                        '<div class="vjs-close-btn"></div></div>'
                    ),
                  ...
                  for (c = 0, u = j.length; c < u; c++) {
                    ...
                    if (
                      ...
                      if (v) {
                        var B =
                          j[c].height.toString() +
                          "-" +
                          j[c].bitrate.toString();
                        j[c].height > 0 && j[c].bitrate > 0 && d == l
                          ? (vjs_inArray(B, k) > -1 &&
                              ((E = L + " vjs-hidden"),
                            ...
                            (g +=
                              ...
                              " kbps)</i></li>"))
                          : j[c].height > 0 && l > d
                          ? (vjs_inArray(j[c].height, C) > -1 &&
                              ((E += " vjs-hidden"), (M += " vjs-hidden")),
                            (m +=
                              '<li class="' +
                              E +
                              '" data-id="' +
                    ...
                    A.push(j[c].bitrate),
                      C.push(j[c].height),
                      (_ = j[c].height
                        ? j[c].height.toString() + "-" + j[c].bitrate.toString()
                        : j[c].bitrate.toString()),
                      k.push(_);
                  }
                  s &&
                    ((m +=
                      '<li class="item-quality" data-id="Autores" data-res="Autores"' +
                      P +
                      ' role="menuitem" aria-live="polite" aria-disabled="false">Auto'),
                    (g +=
                      '<li class="full-quality" data-id="Autores_full" data-res="Autores"full-quality vjs-checked role="menuitem" aria-live="polite" aria-disabled="false">Auto'),
                    "hls" == e &&
                      n &&
                      ((m += '<i class="autores">' + n + "p</i>"),
                  ...
                  (D.onclick = function () {
                    ...
                    i.removeClass(
                      vjs_find(o, ".vjs-quality-button"),
                      "vjs-hidden"
                    );
                  var S = vjs_mfind(o, ".item-quality"),
                    z = vjs_mfind(o, ".full-quality");
                  for (
                    ve("auto", "Auto"), re(), r.menutouch = !1, de(), c = 0;
                    c < S.length;
                    c++
                  ) {
                    (H = S[c]), (item2 = z[c]);
                    var N = function (s) {
                      ...
                      if (
                        ((vjs_find(h, ".vjs-menu").style.display = "none"),
                        i.removeClass(o, "vjs-overflow"),
                        "dash" == e)
                      ) {
                        "Autores" == c || "Autores_full" == c
                          ? (t.dash.mediaPlayer.setAutoSwitchQualityFor(
                              "video",
                              !0
                            ),
                            ve("auto", "Auto"),
                        ...
                        "Autores" == c || "Autores_full" == c
                          ...
                          : ((r.is_auto = !1),
                            ...
                            t.tech_.hls.representations().forEach(function (e) {
                              if (
                                c == u ||
                                parseInt(e.bandwidth / 1e3) == parseInt(c)
                              ) {
                    ...
                    t.on("mediachange", function () {
                      if (1 == r.is_auto && "hls" == e) {
                        ...
                        t.tech_.hls.representations().forEach(function (e) {
                          if (
                            parseInt(s.attributes.BANDWIDTH) ==
                            parseInt(e.bandwidth)
                          )
                            if (e.height > 0) {
                              var t = !1;
                              if (r.hdicon) {
                                var i = "HD",
                                  n = parseInt(e.height);
                                n > 2159 && (i = "4K"), n > 719 && (t = !0);
                              }
                              var a = vjs_find(o, ".vjs-quality-button span");
                              (a.innerHTML = t
                                ? 'Auto<i class="vjs-hd-icon vjs-hd-home">' +
                                  i +
                                  "</i>"
                                : "Auto"),
                                O(e.height + "p");
                              ...
                              e.bandwith > 0 &&
                                O(parseInt(e.bandwidth / 1e3) + "kbps");
                        });
                      }
                    }),
                      item2.className.indexOf("vjs-hidden") < 0 &&
                      ...
                      H.className.indexOf("vjs-hidden") < 0 &&
          ...
          var U,
            R = vjs_find(o, ".vjs-play-progress");
          (U = vjs_find(R, ".vjs-time-tooltip")) &&
            (U.className = "vjs-time-tooltip");
        }
        r.mousedisplay &&
          (U = vjs_find(o, ".vjs-mouse-display")) &&
          (U.className = "vjs-mouse-display");
        if (0 != r.videoInfo && ("" != r.infoText || "" != r.title)) {
          ...
          var J = "";
          (F.onclick = function () {
            window.open(Q, r.target), (r.waslink = !0);
          }),
      ...
      if ((G = t.options_.sources).length > 0) {
        ...
        -1 !== N.indexOf("dash") && J && t.src(G), t.resetNuevo(!1), ue();
      } else t.resetNuevo(!1), ue();
      if (
        ...
        (t.changeSrc = function (e) {
          if (
            ...
            if (e.sources) {
              for (
                void 0 !== e.slideImage
                  ? (r.slideImage = e.slideImage)
                  : (r.slideImage = ""),
                  fe(),
                  void 0 !== e.title && (r.metatitle = r.title = e.title),
                  void 0 !== e.shareTitle &&
                    (r.metatitle = r.title = e.shareTitle),
                  void 0 !== e.metatitle && (r.metatitle = e.metatitle),
                  void 0 !== e.subtitle && (r.metasubtitle = e.subtitle),
                  void 0 !== e.metasubtitle &&
                    (r.metasubtitle = e.metasubtitle),
                  s = 0;
                s < e.sources.length;
                s++
              )
                e.sources[s].metatitle ||
                  e.sources[s].title ||
                  (e.sources[s].metatitle = r.metatitle),
                  !e.sources[s].metatitle &&
                    e.sources[s].title &&
                    (e.sources[s].metatitle = e.sources[s].title),
                  e.sources[s].metasubtitle ||
                    e.sources[s].subtitle ||
                    (e.sources[s].metasubtitle = r.metasubtitle),
                  !e.sources[s].metasubtitle &&
                    e.sources[s].subtitle &&
                    (e.sources[s].metasubtitle = e.sources[s].subtitle);
              ...
              if (
                ...
                for (s = 0; s < a.length; s++)
                  void 0 !== a[s].src &&
                    "captions" == a[s].kind &&
                    (a[s].default && (a[s].mode = "showing"),
                    (a[s].language = a[s].srclang));
                a.length > 0 && (t.captions = a);
              }
              if (
                ("video/mp4" != e.sources[0].type &&
                  "video/webm" != e.sources[0].type &&
                  t.src(e.sources),
                t.resetNuevo(!0, e),
                void 0 !== e.poster)
              )
              ...
              if (void 0 !== e.tracks)
                for (a = e.tracks, s = 0; s < a.length; s++)
                  void 0 !== a[s].src &&
                    (a[s].default &&
                      ((a[s].mode = "showing"), (t.currentTrack = a[s].src)),
              ...
              (r.infoText = r.metatitle), void 0 !== e.url && (r.url = e.url);
            }
          }
        }),
        t.on("playlistready", function () {
          r.playlistRepeat && t.playlist.repeat(!0),
            (function () {
              if ((p = t.playlist.list()).length < 2) return;
              t.playlist.repeat();
              if (1 != r.playlist) {
                if (((r.playlist = !0), r.playlistNavigation)) {
                  var s = vjs_El(
                      "div",
                ...
                if (r.playlistUI) {
                  ...
                  o.appendChild(d),
                    e.browser.TOUCH_ENABLED
                      ? (d.ontouchstart = function (e) {
                          e.stopImmediatePropagation(), v();
                        })
                  ...
                  r.playlistShow &&
                    (c.className = "vjs-vplaylist vjs-vplaylist-show");
                  var u = vjs_El("div", "vjs-head", "<span>PLAYLIST</span>"),
                    f = vjs_El("div", "vjs-back", "<i></i>");
                  u.appendChild(f), c.appendChild(u), o.appendChild(c);
                  ...
                  for (j = 0; j < p.length; j++) {
                    ...
                    p[j].thumb
                      ? (y.style.backgroundImage = "url(" + p[j].thumb + ")")
                      : p[j].poster &&
                        (y.style.backgroundImage = "url(" + p[j].poster + ")"),
                      g.appendChild(y);
                    var b = vjs_El("p");
                    if (p[j].title) b.innerHTML = p[j].title;
                    else {
                      ...
                      (C = C.replace(/(\.[^/.]+)+$/, "")), (b.innerHTML = C);
                    }
                    if ((g.appendChild(b), p[j].duration)) {
                      var A = vjs_El("span");
                      (A.innerHTML = p[j].duration), g.appendChild(A);
                    }
                    h.appendChild(g);
                    var k = !1;
                    function T(e) {
                    ...
                    for (
                      g.onclick = function (e) {
                        e.stopPropagation(), e.stopImmediatePropagation(), T(e);
                      },
                  ...
                  h.appendChild(w), SmScroll.initEl(h);
                }
              }
              t.on("playlist_newitem", function (e, s) {
                ...
                if (r.playlistUI)
                  for (
                    var a = vjs_mfind(o, ".vjs-vlist .vjs-item"), l = 0;
                    l < a.length;
                    l++
                  )
                ...
                t.on("play", function () {
                  if (r.playlistUI) {
                    for (
                      var e = vjs_mfind(o, ".vjs-vlist .vjs-item"), s = 0;
                      s < e.length;
                      s++
                    )
                      i.removeClass(e[s], "vjs-active-item"),
                        e[s].getAttribute("data-id") == n &&
                          i.addClass(e[s], "vjs-active-item");
                  ...
                  if (r.playlistNavigation) {
                    ...
                    0 == t.playlist.currentIndex()
                      ? i.addClass(vjs_find(l, ".vjs-prev"), "vjs-disabled")
                      : i.removeClass(vjs_find(l, ".vjs-prev"), "vjs-disabled"),
                      t.playlist.currentIndex() == t.playlist.lastIndex()
                        ? i.addClass(vjs_find(d, ".vjs-next"), "vjs-disabled")
                        : i.removeClass(
                            vjs_find(d, ".vjs-next"),
                            "vjs-disabled"
                          );
                ...
                try {
                  if (t.isInPictureInPicture()) {
                    ...
                    var d = !1;
                    t.on("play", function () {
                      1 != d && ((d = !0), t.requestPictureInPicture());
                    });
                  }
                } catch (e) {}
              });
        ...
        t.ready(function () {
          ...
          function l(e) {
            ...
            try {
              vjs_find(o, ".vjs-quality-button .vjs-menu").style.display =
                "none";
            } catch (e) {}
          }
            ...
            t.on("ended", function () {
              ...
              i.addClass(b, "vjs-hidden"),
                ...
                s &&
                  ...
                  "" != r.endAction
                    ? "share" == r.endAction && r.shareMenu
                      ? (i.addClass(
                          vjs_find(o, ".vjs-menu-settings"),
                          "vjs-hidden"
                        ),
                        i.removeClass(
                          vjs_find(o, ".vjs-sharing-overlay"),
                          "vjs-hidden"
                        ),
                        (r.isAddon = !0))
                      : "related" == r.endAction &&
            ...
            if (
              ...
              if (2 == e.length)
                if (e[0] == r.video_id && Number(e[1]) > 3) {
                  var s = Number(e[1]);
                  setTimeout(function () {
                    me("vjs_resume", r.video_id + ",0"), t.currentTime(s);
                  }, 500);
                }
            }
          }
          t.on("useractive", function () {
            ...
            t.on("userinactive", function () {
              ...
              if ((e && i.addClass(e, "vjs-hidden"), o.offsetWidth > 480)) {
            ...
            t.on("play", function () {
              if (!h) {
                ...
                if (r.limit > 0 && ("" != r.limiturl || "" != r.url)) {
                  ...
                  t.on("timeupdate", function () {
                    if (
                      t.currentTime() > r.limit &&
                      (t.pause(), (b.style.display = "none"), 1 != s)
                    ) {
                      s = !0;
                ...
                localStorage &&
                  localStorage.volume &&
                  t.volume(localStorage.volume);
                var n = !1;
                if (
                  ((r.relatedMenu || r.shareMenu || r.rateMenu || r.zoomMenu) &&
                    (n = !0),
                  n)
                ) {
                  var a = "",
                  ...
                  if (r.rateMenu) {
                    ...
                    l = vjs_El(
                      ...
                      '<ul class="vjs-menu-content"><li class="vjs-settings-back">' +
                        t.localize("Speed") +
                        '</li><li class="vjs-speed">0.5x</li><li class="vjs-speed vjs-checked">1x</li><li class="vjs-speed">1.5x</li><li class="vjs-speed">2x</li></ul>'
                    );
                  }
                    ...
                    for (
                      var j = function (e) {
                          ...
                          if (
                            ...
                            (vjs_find(
                              o,
                              ".vjs-extend-speed span"
                            ).innerHTML = n),
                            parseFloat(s) > 0)
                          ) {
                            t.playbackRate(s);
                            for (
                              var a = o.querySelectorAll(".vjs-speed"), r = 0;
                              r < a.length;
                              r++
                            )
                        ...
                        g = o.querySelectorAll(".vjs-speed"),
                        y = 0;
                      y < g.length;
                      y++
                    )
                  ...
                  if (r.related.length > 1 && r.relatedMenu) {
                    ...
                    if (
                      ...
                      var E =
                        parseInt(vjs_find(o, ".vjs-prev").offsetWidth) + 5;
                      (vjs_find(o, ".vjs-arrow-prev").style.left =
                        parseInt(w.style.left) - E + "px"),
                        (vjs_find(o, ".vjs-arrow-next").style.left =
                          I + parseInt(w.style.left) + "px");
                    }
                    ...
                    _ < 7 &&
                      1 != A &&
                      (i.addClass(vjs_find(o, ".vjs-arrow-next"), "vjs-hidden"),
                    ...
                    1 != A &&
                      ((vjs_find(o, ".vjs-arrow-next").onclick = function (e) {
                        S(e);
                      }),
                      (vjs_find(o, ".vjs-arrow-next").onctouchstart = function (
                        e
                      ) {
                        S(e);
                      }));
                    ...
                    1 != A &&
                      ((vjs_find(o, ".vjs-arrow-prev").onclick = function (e) {
                        z(e);
                      }),
                      (vjs_find(o, ".vjs-arrow-prev").onctouchstart = function (
                        e
                      ) {
                        z(e);
                      })),
                      vjs_find(o, ".vjs-related-button").addEventListener(
                        setEvent("click"),
                        function (e) {
                          e.preventDefault(),
                            e.stopImmediatePropagation(),
                  ...
                  if (r.shareMenu) {
                    var H = vjs_El("div", "vjs-sharing-overlay vjs-hidden"),
                      ...
                      R =
                        (R =
                          ...
                          t.localize("Link") +
                          '</h2><input type="text" class="perma"><h2>' +
                          t.localize("Embed") +
                          '</h2><input class="embed-code" type="text"></div>') +
                        '<div class="vjs-inputs-body"><h2>' +
                        t.localize("Social") +
                        "</h2></div>";
                    (R +=
                      ...
                      vjs_find(o, ".vjs-share-button").addEventListener(
                        setEvent("click"),
                        function (e) {
                          e.preventDefault(),
                            e.stopImmediatePropagation(),
                    ...
                    var F = {
                        ...
                        description:
                          t.localize("Check out this cool video on") +
                          " " +
                          r.url,
                        pubid: r.pubid || null,
                      },
                    ...
                    (vjs_find(o, ".vjs-inputs-body").onclick = function (e) {
                      ...
                      (vjs_find(o, ".vjs-share-close").ontouchstart = function (
                        e
                      ) {
                        K();
                      });
                  ...
                  if (r.zoomMenu) {
                    var X,
                      Z,
                      J,
                      G = vjs_find(o, ".vjs-poster");
                    if (
                      (i.removeClass(G, "vjs-hidden"),
                      G.setAttribute("style", ""),
                      (G.style.display = "inline-block"),
                      (G.style.opacity = 0),
                      e.browser.TOUCH_ENABLED &&
                        (vjs_find(o, ".vjs-tech").style.pointerEvents = "none"),
                      r.zoomInfo)
                    ) {
                      var V = vjs_El("div", "vjs-zoom-parent vjs-hidden"),
                        $ = vjs_El("div", "vjs-reset-zoom");
                      ($.innerHTML = t.localize("100%")), V.appendChild($);
                      var ee = vjs_El("div", "vjs-reset-center"),
                        te = vjs_El("div", "vjs-reset-cancel");
                      V.appendChild(ee), V.appendChild(te);
                      ...
                      function ne(e) {
                        e.preventDefault(),
                          e.stopPropagation(),
                          i.hasClass(ie, "vjs-hidden")
                            ? (i.removeClass(ie, "vjs-hidden"),
                              i.addClass(b, "vjs-hidden"))
                    ...
                    vjs_find(o, ".vjs-zoom-reset").addEventListener(
                      "mouseup",
                      pe,
                      !1
                    ),
                    ...
                    if (
                      ...
                      function me(e) {
                        ...
                        if (1 != i.hasClass(n, "vjs-hidden")) {
                          var a = ((c - 1) / 4) * 100;
                          (vjs_find(o, ".vjs-zoom-level").style.height =
                            a + "%"),
                            ae(100 * c);
                        }
                        return !1;
                    ...
                    function _e(e) {
                      if (c > 1) {
                        ...
                        try {
                          J = [
                            t.offsetLeft - e.touches[0].clientX,
                            t.offsetTop - e.touches[0].clientY,
                          ];
                        } catch (e) {}
                    ...
                    function Ce(e) {
                      if ((e.preventDefault(), X)) {
                        try {
                          Z = { x: event.clientX, y: event.clientY };
                        } catch (e) {}
                        try {
                          Z = {
                    ...
                    G.addEventListener("mousedown", _e, !0),
                      ...
                      vjs_find(o, ".vjs-zoom-slider").addEventListener(
                        "click",
                        function (e) {
                          e.preventDefault(),
                            e.stopPropagation(),
                      ...
                      vjs_find(o, ".vjs-zoom-slider").addEventListener(
                        ...
                        function (e) {
                          ...
                          ke(e, t);
                          var s = function (e) {
                              e.preventDefault(), e.stopPropagation(), ke(e, t);
                            },
                            i = function (e) {
                              e.preventDefault(),
                                e.stopPropagation(),
        ...
        (t.controlBar.mirrorButton = t.controlBar.addChild("button", {
          ...
          t.controlBar.el_.insertBefore(
            t.controlBar.mirrorButton.el_,
            t.controlBar.getChildById("settings_button").el_
          );
        var V = function (e) {
          e.preventDefault();
          var t = o.className,
          ...
          var n,
            a = !1;
          (t.indexOf("vjs-ended") > 0 && (a = !0), s && 1 != a) &&
            (i.hasClass(e.target, "vjs-mirrored")
              ? (i.removeClass(e.target, "vjs-mirrored"),
                ...
                (n.style.oTransform = "rotateY(0)"))
              : (i.addClass(e.target, "vjs-mirrored"),
                ((n = vjs_find(o, ".vjs-tech")).style.transform =
                  "rotateY(180deg)"),
                n.style.transform,
      ...
      (n.el_.innerHTML =
        ...
        s
          ? "party" == e.options.skinname
            ...
            : t.controlBar.el_.insertBefore(
                n.el_,
                t.controlBar.getChild("playToggle").el_
              )
          : t.controlBar.el_.insertBefore(
              n.el_,
              t.controlBar.getChild("playToggle").el_.nextSibling
    ...
    function ne() {
      try {
        for (
          var e = vjs_mfind(o, ".full_quality"),
            t = vjs_mfind(o, ".item-quality"),
            s = 0;
          s < t.length;
          s++
        )
      ...
      try {
        for (
          ...
          (item = t[s]), (item.ontouchstart = null), (item.onclick = null);
      } catch (e) {}
    ...
    function re() {
      ...
      if (l > 1) {
        var n = function (e) {
          if (
            (e.preventDefault(), e.stopPropagation(), "none" == s.style.display)
          ) {
          ...
          } else (s.style.display = "none"), i.removeClass(o, "vjs-overflow");
          le();
        };
        (t.onclick = function (e) {
          n(e);
      ...
      var y = function (e) {
        if (
          ...
          t.className;
          if (
            (i.removeClass(vjs_find(o, ".vjs-menu"), "vjs-lock-showing"),
    ...
    function oe() {
      ...
      if (e.browser.IS_TOUCH_ENABLED) var s = 0.9;
      else s = 0.8;
      if (vjs_find(o, ".rel-block")) {
        ...
        isNaN(c) && (c = 0), parseInt(c) < 100 && (c = 800), l > c && (l = c);
        var u = vjs_find(o, ".vjs-related");
        (u.style.maxWidth = "800px"), (u.style.width = 100 * s + "%");
        var f = 3,
          h = 2;
        t < 5 && 3 != t && (f = 2),
          t < 4 && (h = 1),
        ...
        for (
          var k = 0, T = 0, w = o.querySelectorAll(".rel-parent"), x = 0;
          x < w.length;
          x++
        ) {
          var I = w[x];
    ...
    function de() {
      ...
      i.hasClass(l, "vjs-hidden") && (r = !0),
        ...
        (a.cogMenu = { width: l.offsetWidth, height: l.offsetHeight }),
        e &&
          (i.addClass(vjs_find(o, ".vjs-settings-home"), "vjs-hidden"),
          t && i.addClass(vjs_find(o, ".vjs-zoom-menu"), "vjs-hidden"),
          i.removeClass(e, "vjs-hidden"),
          i.addClass(e, "vjs-invisible"),
          (a.speedMenu = { width: e.offsetWidth, height: e.offsetHeight }),
        ...
        t &&
          ...
          (a.zoomMenu = { width: t.offsetWidth, height: t.offsetHeight }),
    ...
    function ve(e, t) {
      ...
      if (r.hdicon) {
        ...
        s > 2159 && (n = "4K"),
          s > 719 &&
            ((i = '<i class="vjs-hd-icon vjs-hd-home">' + n + "</i>"),
      ...
      if (
        ...
        (v.src = r.slideImage),
          "horizontal" == r.slideType
            ? ((v.style.width = "auto"),
              (v.style.height = r.slideHeight + "px"))
            : ((v.style.height = "auto"),
        ...
        (c.src = r.slideImage),
          (c.onload = function () {
            ...
            var c = this.width,
              u = this.height,
              f = c / r.slideWidth;
            if ("horizontal" != r.slideType) f = u / r.slideHeight;
            (vjs_find(o, ".vjs-progress-holder").onmousemove = function (s) {
              vjs_find(o, ".vjs-tech-chromecast") ||
                (vjs_find(o, ".vjs-progress-slide") &&
                  (function (s) {
                    parseInt(t.duration());
                    var i = vjs_find(o, ".vjs-progress-holder").offsetWidth,
                      n = parseFloat(
                        vjs_find(o, ".vjs-mouse-display").style.left
                      );
                    if ("auto" == n) {
                      var c = parseFloat(
                        vjs_find(o, ".vjs-mouse-display").style.left
                    ...
                    var m = parseInt(u * f);
                    if (
                      ((vjs_find(o, ".vjs-thumb").style.width =
                        r.slideWidth + "px"),
                      (vjs_find(o, ".vjs-thumb").style.height =
                        r.slideHeight + "px"),
                      "horizontal" == r.slideType)
                    ) {
                      ...
                      (g = m * r.slideHeight), (v.style.top = "-" + g + "px");
                    n < 0 && (n = 0), n > i && (n = i), (d.innerHTML = p);
    ...
    function pe() {
      je(),
        (c = 1),
        i.removeClass(b, "vjs-hidden"),
        vjs_find(o, ".vjs-poster").setAttribute(
          "style",
      ...
      var t = vjs_find(o, ".vjs-tech");
      ge(t, 1), (t.style.top = 0), (t.style.left = 0);
      vjs_find(o, ".vjs-menu-settings"), vjs_find(o, "vjs-vjs-settings-home");
      ae(100);
      var s = vjs_find(o, ".vjs-zoom-parent");
      return (
        1 != i.hasClass(s, "vjs-hidden") && i.addClass(s, "vjs-hidden"),
        (e.options.blockKeys = !1),
        !1
      );
    }
  ...
  return (e.registerPlugin || e.plugin)("nuevo", r), r;
}),
  (function (e, t) {
    "object" == typeof exports && "undefined" != typeof module
      ? (module.exports = t(require("video.js")))
      : "function" == typeof define && define.amd
      ? define(["video.js"], t)
      : ((e = e || self).videojsPlaylist = t(e.videojs));
  })(this, function (e) {
    e = e && e.hasOwnProperty("default") ? e.default : e;
    var t = !1,
      s = function (e) {
      ...
      i = function e(t, i) {
        var n;
        (s(t), "number" == typeof (n = i) && !isNaN(n) && n >= 0 && n < 1 / 0)
      ...
      n = function (e, s) {
        ...
        return (
          s.playlistItemId_ &&
            (e.playlist.currentPlaylistItemId_ = s.playlistItemId_),
          e.changeSrc(s),
          1 != t ? (t = !0) : e.trigger("playlist_change"),
          e.ready(function () {
            if (
              (e.trigger("playlistitem", s.originalValue || s),
              e.trigger("playlist_newitem", { id: s.playlistItemId_ }),
              n)
            ) {
              var t = e.play();
              void 0 !== t &&
        ...
        !(function (t, v, c) {
          ...
          var u = null,
            ...
            h = (t.playlist = function (e, s) {
              if ((void 0 === s && (s = 0), f))
                throw new Error(
                  "do not call playlist() during a playlist change"
                );
              if (Array.isArray(e)) {
          ...
          t.on("loadstart", function () {
            ...
            (h.currentItem = function (e) {
              ...
              if (h.currentPlaylistItemId_) {
                ...
                if (i && Array.isArray(i.sources) && d([i], t) > -1)
                  return (h.currentIndex_ = s), h.currentIndex_;
                h.currentPlaylistItemId_ = null;
              }
            ...
            (h.indexOf = function (e) {
              ...
              for (
                var t = Array.isArray(e) ? e : e.sources, s = 0;
                s < t.length;
                s++
              ) {
                var i = t[s];
            ...
            (h.repeat = function (t) {
              return void 0 === t
                ? h.repeat_
                : "boolean" == typeof t
                ? ((h.repeat_ = !!t), h.repeat_)
                : void e.log.error(
                    "videojs-playlist: Invalid value for repeat",
                    t
                  );
            }),
            (h.list = function () {
  ...
  (function (e, t) {
    ...
    function t(t, s) {
      var i,
        ...
        k = !1,
        T = !1,
        w = (new Array(), t.$(".vjs-tech"));
      (e.isAd = !1), e.browser.IS_IOS && (C = !0), e.ignoreIOS && (C = !1);
      var x = e.dom;
      if (!Array.isArray(s)) {
        var I = s;
        if (
      ...
      t.ready(function () {
        if (c.length > 0) {
          if (C) {
            ...
            var s =
              '<div class="roll-btn roll-play-pause roll-paused"></div><div class="roll-countdown">' +
              t.localize("Advertisement") +
              '</div><div class="roll-btn roll-fscreen roll-non-fullscreen"></div>';
          ...
          t.on("loadeddata", function () {
            if (
              (t.el_.className.indexOf("vjs-live") > -1 && (j = !0),
              t.duration() === 1 / 0 && (j = !0),
            ...
            function P(e) {
              for (
                ...
                var a = s[n];
                i.push({ track: a, mode: a.mode }), (a.mode = "disabled");
              }
            ...
            function M(t) {
              ...
              1 != j && (i = t.ended());
              for (
                var n = t.textTracks ? t.textTracks() : [],
                  a = [],
                  r = {
                    ended: i,
                ...
                var l = n[o];
                a.push({ track: l, mode: l.mode }), (l.mode = "disabled");
              }
            ...
            if ((c.length > 1 && (c = sortByKey(c, "offset")), c.length > 0)) {
                    ...
                    if (C) {
                      if (
                        ...
                        t.pause(),
                          ...
                          (T = !1),
                          (v = j ? P(t) : M(t));
                        var _ = { src: y.src, type: y.type };
                        function A() {
                          (u = !0), t.off("playing", A);
                        }
                        t.src(_),
                          x.addClass(
                            vjs_find(t.el_, ".vjs-control-bar"),
                            "vjs-hidden"
                          ),
                          "" != y.href
                            ? ((a.href = y.href),
                              (a.className = "roll-blocker"))
                      ...
                      (r >= y.offset &&
                        ...
                        (1 != y.loaded && 1 != p
                          ? ((p = !0),
                            ...
                            (d = y),
                            (a.href = y.href))
                          : 1 != y.loaded && ((c[m].loaded = !0), h.push(y))),
              ...
              j
                ? t.on("playing", function () {
                    1 != m && ((m = !0), (g = setTimeout(B, 500)), (T = !0));
                  })
                : t.on("timeupdate", function () {
                    D(t.currentTime());
                  }),
                j &&
                  ...
                  t.on("playing", function (e) {
                    1 != p &&
                      c.length > 0 &&
                      1 != T &&
                      ((T = !0), (g = setTimeout(B, 500)));
                  })),
                c.length > 0 &&
                  ((0 != c[0].offset && "0" != c[0].offset) ||
                    C ||
                    ((p = !0),
                    (u = !0),
                    clearTimeout(g),
                    ...
                    t.on("playing", function () {
                      if (1 != k) {
                        ...
                        (w.poster = ""),
                          ...
                          1 != f &&
                            (d.id &&
                              t.trigger("vroll", { id: d.id, action: "play" }),
                            (f = !0));
                        try {
                          i.removeChild(o);
                        } catch (e) {}
                        (b = d.skip > 0 ? parseInt(d.skip) : 0),
                          x.removeClass(i, "vjs-hidden"),
                          t.paused() || (t.pause(), S(), b > 0 && W());
                      }
                    })));
              function S() {
                t.pause(), clearTimeout(g), (T = !1), 0;
                var s = n.play();
                void 0 !== s &&
                  s
                    .then(function () {})
              ...
              a.onclick = function () {
                (a.className = "roll-blocker vjs-hidden"),
                  null != d.id &&
                    t.trigger("vroll", { id: d.id, action: "click" });
              };
              var z = function () {
                  ...
                  if ((!1, (f = !1), (d = void 0), 1 != C)) {
                    ...
                    if (h.length > 0) {
                      ...
                      for (var s = 0; s < c.length; s++)
                        h.src == c[s].src &&
                          ((c[s].loaded = !0), (c[s].done = !0));
                      (n.src = d.src),
                        (n.type = d.type),
                        (a.href = d.href),
                        d.skip > 0 ? ((b = parseInt(d.skip)), W()) : (b = 0),
                        h.shift(),
                        t.pause(),
                        S(),
                        b > 0 && W();
                    ...
                    if (
                      ...
                      0, (p = !0), (u = !0), (c[0].loaded = !0), (e.isAd = !0);
                      var y = { src: (d = c[0]).src, type: d.type };
                      t.src(y),
                        t.load(),
                        x.addClass(
                          vjs_find(t.el_, ".vjs-control-bar"),
                        ...
                        "" != d.href
                          ? ((a.href = d.href), (a.className = "roll-blocker"))
                          : (a.className = "roll-blocker vjs-hidden"),
                        (l.className = "vjs-roll-controls"),
                        t.play();
                      try {
                    ...
                    if (1 != m) {
                      ...
                      g = vjs_find(t.el_, ".vjs-poster");
                      x.addClass(g, "vjs-hidden"),
                        (vjs_find(t.el_, ".vjs-loading-spinner").style.display =
                          "block"),
                        (w.poster = ""),
                        j
                          ? (t.src(v.source), t.play())
                          : (!(function (t, s, i) {
                              void 0 === i && (i = function () {});
                              var n,
                                a = s.suppressedTracks,
                                r = void 0,
                                o = function (e) {
                              ...
                              (w.poster = ""),
                                "style" in s &&
                                  w.setAttribute("style", s.style || ""),
                                t.src({ src: s.currentSrc, type: s.type }),
                                t.load(),
                                (n = void 0),
                                C && j
                                  ? s.currentTime < 0 &&
                                    ((n =
                                      t.seekable().length > 0
                                        ? t.seekable().end(0) + s.currentTime
                                        : t.currentTime()),
                                    t.currentTime(n))
                                  : s.ended
                                  ? ((vjs_find(
                                    ...
                                    (e.isAd = !1))
                                  : C
                                  ? (t.on("loadeddata", o), t.play())
                                  : (t.currentTime(s.currentTime), t.play()),
                                (function () {
              ...
              function O(e, s) {
                ...
                if (
                  ...
                  !isNaN(n) && !isNaN(a)) &&
                  ((vjs_find(l, ".roll-countdown").innerHTML =
                    t.localize("Advertisement") +
                    "<span>" +
                    n +
                    ":" +
                  ...
                  if (r > 0)
                    ...
                    A &&
                      "roll-skip-button enabled" != o.className &&
                      ((o.innerHTML =
                        "<span>" +
                        t.localize("Skip Now!") +
                        '</span><i class="circle"></i>'),
              ...
              function W() {
                ...
                function e(e) {
                  e.stopPropagation(),
                    (" " + o.className + " ").indexOf(" enabled ") >= 0 &&
                      (d.id && t.trigger("vroll", { id: d.id, action: "skip" }),
                      N());
                }
              ...
              function U(e) {
                ...
                var t = vjs_find(l, ".roll-mute");
                H()
                  ? (r == n ? (r.muted = !1) : r.muted(!1),
                    x.addClass(t, "roll-non-muted"),
                    x.removeClass(t, "roll-muted"))
                  : (r == n ? (r.muted = !0) : r.muted(!0),
                    x.addClass(t, "roll-muted"),
                    x.removeClass(t, "roll-non-muted"));
              }
              C
                  ...
                  r.on("timeupdate", function () {
                    if (p && !z()) {
                      ...
                      if (r == n) var s = n.currentTime;
                        ...
                        (s = r.currentTime()) > 0 &&
                          x.removeClass(t.$(".vjs-tech"), "vjs-hidden");
                      O(s, e);
                    }
                  }),
              ...
              (R.onclick = function (e) {
                ...
                t.on("fullscreenchange", function () {
                  t.isFullscreen()
                    ? (x.addClass(R, "roll-fullscreen"),
                      x.removeClass(R, "roll-non-fullscreen"))
                    : (x.addClass(R, "roll-non-fullscreen"),
